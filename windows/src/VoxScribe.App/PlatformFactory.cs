...
/// <remarks>
/// <para>
/// <b>Why reflection rather than a project reference:</b> <c>VoxScribe.Platform.Windows</c>
...
{
    private const string AssemblyName = "VoxScribe.Platform.Windows";
    private const string Namespace = "VoxScribe.Platform.Windows";
    ...
    /// one is deliberately invisible to it — that is what keeps <c>VoxScribe.App</c> on plain
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "VoxScribe.Platform.Windows ships whole beside the executable and is "
    ...
    /// <summary>Re-points an existing login entry at the current executable path.</summary>
    public static void RepairLaunchAtLogin() => StartupCall("Repair", null);
