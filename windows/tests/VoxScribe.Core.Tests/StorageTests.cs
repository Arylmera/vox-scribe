...
{
    private readonly string _path = Path.Combine(Path.GetTempPath(), $"voxscribe-dict-{Guid.NewGuid():N}.txt");
...
{
    private readonly string _path = Path.Combine(Path.GetTempPath(), $"voxscribe-hist-{Guid.NewGuid():N}.jsonl");
...
{
    private readonly string _path = Path.Combine(Path.GetTempPath(), $"voxscribe-set-{Guid.NewGuid():N}.json");
